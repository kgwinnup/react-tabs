...
/***/ function(module, exports, __webpack_require__) {
	...
	var TabContainer = __webpack_require__(157).TabContainer;
	var Tab = __webpack_require__(157).Tab;
	...
	var Demo = React.createClass({
	    ...
	    render: function render() {
	        return React.createElement(
	            TabContainer,
	            null,
	            React.createElement(Tab, { title: 'tab 2', active: false }),
	            React.createElement(Tab, { title: 'tab 2', active: false }),
	            React.createElement(Tab, { title: 'tab 1', active: true }),
	            React.createElement(Tab, { title: 'tab 2', active: false })
	        );
	    }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var PureRenderMixin = __webpack_require__(1).addons.PureRenderMixin;
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".tab-container {\n  position: relative;\n  left: 14px; }\n  .tab-container .tab {\n    border: none;\n    color: #fff;\n    display: inline-block;\n    height: 34px;\n    line-height: 34px;\n    margin: 0 20px 0 5px;\n    position: relative;\n    width: 160px;\n    max-width: 180px;\n    min-width: 120px;\n    font-family: \"Lucida Console\", Monaco, monospace;\n    font-size: 12px;\n    cursor: pointer;\n    transition: color 0.1s ease-in; }\n    .tab-container .tab, .tab-container .tab:before, .tab-container .tab:after {\n      background-image: -webkit-linear-gradient(top, #787878, #666);\n      height: 34px; }\n    .tab-container .tab:after, .tab-container .tab:before {\n      content: '';\n      position: absolute;\n      top: 0px;\n      width: 25px;\n      height: 34px;\n      border-top-left-radius: 4px;\n      border-top-right-radius: 4px; }\n    .tab-container .tab:before {\n      left: -14px;\n      box-shadow: inset 1px 1px 0 #666, -4px 0px 4px rgba(0, 0, 0, 0.1);\n      -webkit-transform: skewX(-30deg); }\n    .tab-container .tab:after {\n      right: -14px;\n      box-shadow: inset -1px 1px 0 #666, 4px 0px 4px rgba(0, 0, 0, 0.1);\n      -webkit-transform: skewX(30deg); }\n    .tab-container .tab .title {\n      position: relative;\n      z-index: 1;\n      padding-right: 10px; }\n      .tab-container .tab .title:hover {\n        -webkit-transition: opacity 0.25s ease-in-out;\n        opacity: 0.5; }\n    .tab-container .tab .close {\n      position: relative;\n      z-index: 1;\n      float: right; }\n    .tab-container .tab .close a {\n      color: #fff;\n      text-decoration: none; }\n    .tab-container .tab .close a:hover {\n      color: #ccc; }\n  .tab-container .tab.active {\n    z-index: 1;\n    color: #fff;\n    box-shadow: inset -1px 1px 0 #4f4f4f, 4px -4px 4px rgba(0, 0, 0, 0.1); }\n    .tab-container .tab.active, .tab-container .tab.active:before, .tab-container .tab.active:after {\n      background-image: -webkit-linear-gradient(top, #616161, #4f4f4f);\n      height: 34px; }\n", ""]);
